...
- [투두리스트](https://nomadcoders.co/community/thread/182)
    - [ReactJS](https://nomadcoders.co/c/reactjs-challenge/join)
- ![](./Images/nomadcoder_1.png) 
...
- React
  ...
  - ReactJS로 영화 웹 서비스 만들기
    ...
    - [ ] [Detail API](https://developers.themoviedb.org/3/movies/get-movie-details) 받아오는 거에 대해 생각해보고 구조 짜기
